...
// credits to: https://github.com/jehugaleahsa/primitive/blob/master/arithmetic_traits.h
...
template<typename TFrom, typename TTo> using is_promotion_v = is_promotion<TFrom, TTo>::value;
template<typename TFrom, typename TTo> using is_conversion_v = is_conversion<TFrom, TTo>::value;
